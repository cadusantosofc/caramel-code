...
INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Qual operador compara se dois valores são iguais?', '["=", "==", "!=", "><"]', 1, 'Um sinal de igual atribui, dois sinais comparam.', '["❌ Incorreto. = atribui valor à variável (ex: x = 5).", "✅ Correto! == compara se dois valores são iguais (ex: if (x == 5)).", "❌ Incorreto. != significa diferente (desigualdade).", "❌ Incorreto. >< não é um operador de comparação válido."]'
FROM modulos WHERE curso_id = 13 AND ordem = 1 LIMIT 1;
...
-- ==========================================
INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é uma função em programação?', '["Um tipo de variável", "Bloco de código reutilizável com nome", "Um loop especial", "Um tipo de dado"]', 1, 'Funções encapsulam código para reutilizar sempre que precisar.', '["❌ Incorreto. Função não é variável.", "✅ Correto! Bloco reutilizável.", "❌ Incorreto.", "❌ Incorreto."]'
FROM modulos WHERE curso_id = 13 AND ordem = 4 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que são parâmetros de uma função?', '["Erros da função", "Valores de entrada que a função recebe", "O resultado da função", "O nome da função"]', 1, 'Parâmetros são as entradas que a função precisa.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 4 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que faz o RETURN numa função?', '["Repete a função", "Retorna um valor como resultado", "Deleta a função", "Chama outra função"]', 1, 'RETURN encerra a função e devolve o valor.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 4 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Chamar uma função significa:', '["Criar a função", "Executar o código da função", "Apagar a função", "Renomear a função"]', 1, 'Invocar = executar a função.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 4 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Qual a vantagem principal de usar funções?', '["Deixa o código mais lento", "Evita repetição de código (reutilização)", "Usa mais memória", "Dificulta a leitura"]', 1, 'Escreva uma vez, use quantas vezes quiser.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 4 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é escopo de variável?', '["Velocidade da variável", "Onde a variável pode ser acessada", "Tipo da variável", "Tamanho da variável"]', 1, 'Escopo define onde a variável pode ser usada.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 4 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Variável LOCAL é:', '["Acessível em todo o programa", "Acessível apenas dentro da função onde foi criada", "Permanente", "Compartilhada entre funções"]', 1, 'Nasce e morre dentro da função.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 4 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Variável GLOBAL é:', '["Acessível apenas num loop", "Acessível em qualquer parte do programa", "Mais rápida que local", "Apagada após uso"]', 1, 'Visível em todo o código.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 4 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é uma função recursiva?', '["Função que nunca termina", "Função que chama a si mesma", "Função sem parâmetros", "Função com muitos returns"]', 1, 'A função chama a si mesma.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 4 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Argumento de uma função é:', '["O nome dado à função", "O valor real passado ao chamar a função", "O tipo de retorno", "O corpo da função"]', 1, 'Argumento é o valor passado na chamada.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 4 LIMIT 1;
...
-- ==========================================
INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Qual tipo de dado armazena texto?', '["int", "float", "string", "boolean"]', 2, 'String = cadeia de caracteres.', '["❌", "❌", "✅ Correto!", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 5 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Qual tipo armazena números INTEIROS?', '["string", "float", "boolean", "int"]', 3, 'INT = inteiro, sem casas decimais.', '["❌", "❌", "❌", "✅ Correto!"]'
FROM modulos WHERE curso_id = 13 AND ordem = 5 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Qual tipo armazena números com vírgula (decimais)?', '["int", "string", "float", "boolean"]', 2, 'FLOAT = ponto flutuante.', '["❌", "❌", "✅ Correto!", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 5 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Qual tipo armazena VERDADEIRO ou FALSO?', '["string", "int", "float", "boolean"]', 3, 'Boolean tem apenas dois valores.', '["❌", "❌", "❌", "✅ Correto!"]'
FROM modulos WHERE curso_id = 13 AND ordem = 5 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é tipagem de dados?', '["Velocidade de digitação", "Definir qual tipo de valor uma variável armazena", "Tamanho do programa", "Tipo de loop"]', 1, 'Cada variável tem um tipo.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 5 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, '"10" (entre aspas) é do tipo:', '["int", "float", "string", "boolean"]', 2, 'Aspas transformam em string.', '["❌", "❌", "✅ Correto!", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 5 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é conversão de tipo (cast)?', '["Apagar uma variável", "Transformar um tipo de dado em outro", "Criar uma constante", "Comparar dois valores"]', 1, 'Ex: string "5" para inteiro 5.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 5 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Concatenar strings significa:', '["Dividir uma string", "Unir duas ou mais strings", "Converter para número", "Apagar caracteres"]', 1, '"Olá" + " Mundo" = "Olá Mundo".', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 5 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Qual destes é um exemplo de valor BOOLEANO?', '["42", "true", "Ola", "3.14"]', 1, 'Boolean só aceita true ou false.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 5 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'NULL em programação representa:', '["Zero", "Falso", "Ausência de valor", "String vazia"]', 2, 'NULL = ausência de valor.', '["❌", "❌", "✅ Correto!", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 5 LIMIT 1;

-- ==========================================
-- FASE 5 - Tipos de Dados (continuação)
-- ==========================================
INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Qual tipo de dado armazena texto?', '["int", "float", "string", "boolean"]', 2, 'String = cadeia de caracteres.', '["❌", "❌", "✅ Correto!", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 5 LIMIT 1;
...
-- ==========================================
INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é um array?', '["Uma variável simples", "Coleção de valores armazenados numa única variável", "Um tipo de loop", "Uma função especial"]', 1, 'Array = lista de valores acessados por índice.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 6 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Qual é o índice do PRIMEIRO elemento de um array?', '["1", "0", "-1", "Depende"]', 1, 'Arrays começam no índice 0.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 6 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Como acessar o terceiro elemento do array frutas[]?', '["frutas[3]", "frutas[2]", "frutas(3)", "frutas.3"]', 1, 'Terceiro elemento = índice 2.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 6 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é o comprimento (length) de um array?', '["O primeiro elemento", "A quantidade total de elementos", "O último índice", "O tipo dos elementos"]', 1, 'Length retorna quantos itens existem.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 6 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Como percorrer todos os elementos de um array?', '["Usando uma variável", "Usando um loop com índice", "Usando uma constante", "Usando boolean"]', 1, 'Loop + índice é o jeito clássico.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 6 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que faz o método push() num array?', '["Remove o primeiro elemento", "Adiciona um elemento no final", "Ordena o array", "Inverte o array"]', 1, 'Push adiciona no final.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 6 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que faz o método pop() num array?', '["Adiciona no final", "Remove e retorna o último elemento", "Limpa o array", "Adiciona no início"]', 1, 'Pop remove o último item.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 6 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Array multidimensional é:', '["Array com um elemento", "Array que contém outros arrays", "Array com apenas strings", "Array vazio"]', 1, 'Array dentro de array.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 6 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O índice do último elemento de um array de 5 itens é:', '["5", "4", "6", "0"]', 1, 'Último índice = length - 1.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 6 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O método sort() num array serve para:', '["Remover duplicatas", "Ordenar os elementos", "Contar elementos", "Inverter a ordem"]', 1, 'Sort organiza os elementos.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 6 LIMIT 1;
...
-- ==========================================
INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é uma pilha (stack)?', '["Lista ordenada por índice", "Estrutura LIFO: último a entrar, primeiro a sair", "Fila de impressão", "Tabela de dados"]', 1, 'LIFO = Last In, First Out.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 7 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é uma fila (queue)?', '["Estrutura LIFO", "Estrutura FIFO: primeiro a entrar, primeiro a sair", "Array desordenado", "Tabela hash"]', 1, 'FIFO = First In, First Out.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 7 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é um objeto em programação?', '["Um tipo de loop", "Estrutura que agrupa dados e comportamentos relacionados", "Um array numérico", "Uma função sem retorno"]', 1, 'Objeto = propriedades + métodos.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 7 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é uma chave-valor (key-value)?', '["Tipo de loop", "Estrutura onde cada valor tem um nome identificador", "Método de ordenação", "Tipo de variável"]', 1, 'Ex: { nome: "João", idade: 25 }', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 7 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Qual estrutura é melhor para busca rápida por chave?', '["Array simples", "Pilha", "Dicionário / Mapa (hash)", "Fila"]', 2, 'Hash permite acesso direto pela chave.', '["❌", "❌", "✅ Correto!", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 7 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Uma lista encadeada (linked list) é:', '["Array com índice fixo", "Sequência de nós onde cada um aponta para o próximo", "Tabela de banco de dados", "Loop infinito"]', 1, 'Cada nó aponta para o próximo.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 7 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é uma árvore (tree) em estrutura de dados?', '["Array bidimensional", "Estrutura hierárquica com nó raiz e filhos", "Fila circular", "Pilha dupla"]', 1, 'Tem raiz, galhos e folhas.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 7 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Qual a operação de inserção numa pilha chama-se:', '["enqueue", "push", "insert", "add"]', 1, 'Push empilha, pop desempilha.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 7 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Complexidade de tempo O(1) significa:', '["Depende do tamanho", "Tempo constante independente do tamanho", "Muito lento", "Exponencial"]', 1, 'Sempre o mesmo tempo.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 7 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é um grafo em computação?', '["Gráfico de barras", "Conjunto de vértices conectados por arestas", "Tabela de dados", "Array tridimensional"]', 1, 'Representa relações entre elementos.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 7 LIMIT 1;
...
-- ==========================================
INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que faz a busca linear?', '["Divide o array ao meio", "Verifica cada elemento um por um", "Usa índice direto", "Ordena antes de buscar"]', 1, 'Vai do primeiro ao último.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 8 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'A busca binária exige que o array esteja:', '["Desordenado", "Ordenado", "Com índice par", "Vazio"]', 1, 'Só funciona em dados ordenados.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 8 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O Bubble Sort funciona:', '["Dividindo o array ao meio", "Comparando e trocando elementos adjacentes repetidamente", "Inserindo em posição correta", "Escolhendo um pivô"]', 1, 'Bolhas sobem.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 8 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O algoritmo Merge Sort usa a técnica de:', '["Força bruta", "Dividir para conquistar", "Busca sequencial", "Pilha recursiva simples"]', 1, 'Divide, ordena e une.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 8 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Qual ordenação é geralmente mais eficiente para grandes volumes?', '["Bubble Sort", "Insertion Sort", "Quick Sort", "Selection Sort"]', 2, 'Quick Sort tem boa performance.', '["❌", "❌", "✅ Correto!", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 8 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Notação Big O serve para:', '["Nomear variáveis", "Medir a eficiência de algoritmos", "Declarar funções", "Definir tipos de dados"]', 1, 'Descreve eficiência.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 8 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O(n²) significa que o tempo de execução:', '["É constante", "Dobra com mais dados", "Cresce com o quadrado do tamanho da entrada", "É logarítmico"]', 2, 'Típico de loops aninhados.', '["❌", "❌", "✅ Correto!", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 8 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Busca binária tem complexidade:', '["O(n)", "O(n²)", "O(log n)", "O(1)"]', 2, 'Muito eficiente.', '["❌", "❌", "✅ Correto!", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 8 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é um algoritmo guloso (greedy)?', '["Usa muita memória", "Faz a melhor escolha local a cada passo", "Testa todas as possibilidades", "Usa recursão obrigatoriamente"]', 1, 'Melhor escolha local.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 8 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Dividir para conquistar (divide and conquer) é:', '["Usar dois loops", "Dividir o problema em partes menores e resolver cada uma", "Força bruta otimizada", "Busca sequencial dupla"]', 1, 'Quebra em problemas menores.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 8 LIMIT 1;
...
-- ==========================================
INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é uma Classe em POO?', '["Um objeto criado", "Molde/modelo para criar objetos", "Um tipo de loop", "Uma variável global"]', 1, 'Classe é a planta, objeto é a casa.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 9 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é um Objeto em POO?', '["O código-fonte", "Instância criada a partir de uma Classe", "Um array especial", "Um tipo de função"]', 1, 'Instância real da classe.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 9 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é Herança em POO?', '["Cópia de código", "Uma classe filha herda atributos e métodos da classe pai", "Tipo de loop especial", "Variável compartilhada"]', 1, 'Reutilização de código.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 9 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é Encapsulamento?', '["Herdar métodos", "Esconder detalhes internos e expor apenas o necessário", "Criar múltiplos objetos", "Misturar tipos de dados"]', 1, 'Proteger os dados internos.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 9 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é Polimorfismo?', '["Criar muitas classes", "Mesmo método com comportamentos diferentes em classes distintas", "Herança múltipla", "Variável com vários tipos"]', 1, 'Muitas formas.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 9 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O construtor de uma classe serve para:', '["Destruir o objeto", "Inicializar o objeto com valores ao ser criado", "Herdar de outra classe", "Retornar um booleano"]', 1, 'Roda automaticamente ao criar o objeto.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 9 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Atributos em POO são:', '["As ações do objeto", "As características/propriedades do objeto", "Os construtores", "Os métodos estáticos"]', 1, 'Ex: cor, marca, velocidade.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 9 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Métodos em POO são:', '["As propriedades do objeto", "As ações/comportamentos que o objeto pode executar", "Os construtores da classe", "Os tipos de dados"]', 1, 'Ex: acelerar(), frear().', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 9 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O modificador "private" em POO significa:', '["Acessível em qualquer lugar", "Acessível apenas dentro da própria classe", "Herdável por filhas", "Estático"]', 1, 'Só a própria classe pode acessar.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 9 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Abstração em POO significa:', '["Copiar outra classe", "Mostrar apenas o essencial, ocultando complexidade", "Criar muitos objetos", "Usar só variáveis globais"]', 1, 'Simplificar o uso.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 9 LIMIT 1;
...
-- ==========================================
INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é código limpo (clean code)?', '["Código sem comentários", "Código legível, organizado e fácil de manter", "Código comprimido", "Código sem variáveis"]', 1, 'Escrito para humanos.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 10 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Por que dar nomes claros a variáveis é importante?', '["Deixa o código mais rápido", "Facilita a leitura e manutenção", "É exigido pelo compilador", "Reduz o tamanho do arquivo"]', 1, 'Código deve se explicar.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 10 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é refatoração de código?', '["Reescrever do zero", "Melhorar a estrutura sem mudar o comportamento", "Adicionar novas funcionalidades", "Corrigir bugs críticos"]', 1, 'Melhorar qualidade sem mudar comportamento.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 10 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'DRY em programação significa:', '["Do Repeat Yourself", "Delete Redundant Yields", "Don''t Repeat Yourself", "Define Reusable Yields"]', 2, 'Não se repita.', '["❌", "❌", "✅ Correto!", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 10 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é versionamento de código?', '["Apagar versões antigas", "Registrar e controlar as mudanças ao longo do tempo", "Compilar versões diferentes", "Testar o código"]', 1, 'Git é a principal ferramenta.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 10 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'Comentários no código servem para:', '["Aumentar a velocidade", "Explicar trechos complexos para outros leitores", "Corrigir erros automaticamente", "Definir variáveis"]', 1, 'Explique o PORQUÊ.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 10 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é um teste unitário?', '["Testar o sistema inteiro", "Testar uma função/unidade isolada", "Testar a interface visual", "Testar o banco de dados"]', 1, 'Testa a menor peça isolada.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 10 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'KISS em programação significa:', '["Keep It Super Secure", "Keep It Simple, Stupid", "Keep Implementing Simple Scripts", "Keep It Structured and Stable"]', 1, 'Mantenha simples.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 10 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O que é documentação de software?', '["O código-fonte", "Descrição de como o sistema funciona e como usá-lo", "Os arquivos de configuração", "Os testes automatizados"]', 1, 'Ajuda outros a entenderem.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 10 LIMIT 1;

INSERT INTO questoes (curso_id, modulo_id, texto, opcoes_json, resposta_correta, dica, explicacoes_json)
SELECT 13, id, 'O princípio SOLID foi criado para:', '["Acelerar compilação", "Guiar o design de software orientado a objetos de qualidade", "Definir tipos de dados", "Organizar banco de dados"]', 1, '5 princípios para bom design.', '["❌", "✅ Correto!", "❌", "❌"]'
FROM modulos WHERE curso_id = 13 AND ordem = 10 LIMIT 1;